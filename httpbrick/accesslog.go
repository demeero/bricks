...
// The middleware extracts a logger instance from request's context and it's expected that the logger is already configured via SlogCtxMW middleware or somehow else.
